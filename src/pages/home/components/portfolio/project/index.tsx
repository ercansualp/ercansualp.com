    ...
    return (
        <article className="p-5 flex flex-col rounded-3xl bg-[#2c2c6c] hover:bg-transparent transition-all border border-[#2c2c6c] hover:border-[#4db5ff66]">
            ...
            <div className="mb-4 flex">
                <Link to={"/"} className="hover:border-white hover:bg-white hover:text-black transition-all text-[#4db5ff] border border-[#4db5ff] py-3 px-5 rounded-md flex items-center justify-center gap-1">
