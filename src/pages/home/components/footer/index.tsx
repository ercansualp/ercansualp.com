    ...
    return (
        <div className="mt-28 py-12 flex flex-col items-center bg-[#4db5ff] text-[#1f1f38]">
            ...
            <div className="fixed z-50 left-1/5 bottom-8 bg-[#0000004d] rounded-[48px] py-3 px-7 flex items-center justify-center gap-x-3">
                <a href="#" className="rounded-full p-3.5 bg-[#4db5ff] transition-all">
                ...
                <a href="#about" className="rounded-full p-3.5 hover:bg-[#0000004d] transition-all">
                ...
                <a href="#skills" className="rounded-full p-3.5 hover:bg-[#0000004d] transition-all">
                ...
                <a href="#portfolio" className="rounded-full p-3.5 hover:bg-[#0000004d] transition-all">
                ...
                <a href="#contact" className="rounded-full p-3.5 hover:bg-[#0000004d] transition-all">
