...
export default function Contact() {
    ...
    return (
        <div id="contacts" className="mt-32 flex flex-col items-center">
            ...
            <div className={classNames("grid gap-8 w-[58%] mx-auto", {
                ...
                <div className="flex flex-col gap-5 text-white">
                    <Item
                        logo={<
                            svg className="mb-2" stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 24 24" height="1.5em" width="1.5em"><path fill="none" d="M0 0h24v24H0V0z" /><path d="M22 6c0-1.1-.9-2-2-2H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6zm-2 0l-8 5-8-5h16zm0 12H4V8l8 5 8-5v10z" /></svg>
                        }
                        title="Email"
